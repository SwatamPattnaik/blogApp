...
class Transaction(models.Model):
    lender = models.ForeignKey('User', models.DO_NOTHING, db_column='lender', blank=True, null=True)
    borrower = models.ForeignKey('User', models.DO_NOTHING, db_column='borrower', blank=True, null=True)
