...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$150000$950Kht2Wb9C9$RS4dDnGrhpNgLIpX7E9UlhrKWRGzpgntzEZoXgs9Kt4=','2021-04-22 07:05:45.817590',1,'admin','','','swatampattnaik@gmail.com',1,1,'2021-04-20 06:04:14.621298'),(4,'pbkdf2_sha256$150000$WR1duFvHWL24$M/DSA6cSLvlQ1lrLLstjv63E3KBUgYvgOvMjzZQ/y0I=','2021-04-21 09:46:18.132922',0,'fury','','','swatampattnaik@gmail.com',0,1,'2021-04-20 06:52:58.667430');
...
INSERT INTO `comment` VALUES (1,1,4,'Test comment',1618986380,1),(2,1,1,'test comment',1618986629,1),(4,1,1,'test comment 2',1618987918,1),(8,1,1,'test comment 3',1618988269,1),(9,5,4,'Test',1618996634,1),(10,5,1,'test comment',1618996674,1),(11,5,1,'test commenttest commenttest commenttest commenttest commenttest commenttest commenttest comment',1618997567,1);
...
INSERT INTO `django_session` VALUES ('2wo2lzih0ek2zkunnahgnzes17js334u','ZDFmNWM1YzlmZmEwZTFiYTQ0MTA4ZGUxOTVkNmFlNTEwMzMzOTVlYzp7Il9hdXRoX3VzZXJfaWQiOiI0IiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiJlNmIyNTg0ZmRkNWM2MThhMzY1YWIyZGM4YzU3MGM3YzMzZWRlYWYzIn0=','2021-05-04 08:42:35.968891'),('br8b3btzyj0inc1qpqfmr5g792n0v92l','MmM1MzAwZGNkZTdlOWE3ZjE1N2QyZjM1MjkyYzYzZDYxZTM5NTNjNTp7Il9hdXRoX3VzZXJfaWQiOiIxIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiIxYzJiYWIxNjdiMjBkNmNlZGI0YzA3MjllYmE1ZGQzYTQzYzM0NjQ3In0=','2021-05-06 07:05:45.932499'),('hnbri0qualic6f00zb3t6myxxth4jyw1','ZDFmNWM1YzlmZmEwZTFiYTQ0MTA4ZGUxOTVkNmFlNTEwMzMzOTVlYzp7Il9hdXRoX3VzZXJfaWQiOiI0IiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiJlNmIyNTg0ZmRkNWM2MThhMzY1YWIyZGM4YzU3MGM3YzMzZWRlYWYzIn0=','2021-05-04 07:46:13.589665');
...
CREATE TABLE `transaction` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `user_lender_fk_idx` (`lender`),
  KEY `user_borrower_fk_idx` (`borrower`),
  CONSTRAINT `user_borrower_fk` FOREIGN KEY (`borrower`) REFERENCES `user` (`id`),
  CONSTRAINT `user_lender_fk` FOREIGN KEY (`lender`) REFERENCES `user` (`id`)
...
INSERT INTO `transaction` VALUES (1,1,2,5),(2,2,1,5),(3,1,2,10);
...
INSERT INTO `user` VALUES (1,'fury'),(2,'swatam'),(3,'test');
...
-- Dump completed on 2021-04-22 13:46:51
